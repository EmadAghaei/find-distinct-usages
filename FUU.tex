...
\end{figure}
\section{Relate Work}
\todo[inline]{There is a plethora of research on information foraging and improving learning by examples (need citation to webpaper in 795 https://dl.acm.org/doi/10.1145/1518701.1518944). There is also a lot of work in code clones  code clone clustering (https://ieeexplore.ieee.org/document/8719895). As far as these authors are aware, this is the first time work on code clones and their clustering have been used to help forage for examples within a codebase. Typically code cloning is used to infer duplicate code snippets for refactoring or patching, https://pdfs.semanticscholar.org/bdae/5ede2999eae51645b5c91004706485a53af0.pdf. This work has attempted to take relevant pieces from each of these fields and it is this combination of parts that is the contribution.} 




\todo [inline]{ HW3 and HW1, We have summary of four papers that we can use hear. Also at the end of ppt of HW1 exist a list of papers that we can talk about them hear. In HW3 notes also there exist material for mentioning as related work: 1) Sameness: An Experiment in Code Search 2) String Distance Using https://github.com/tdebatty/java-string-similarity library}
...
\todo[inline]{Write qualitative description of the short exercises and what was done. Like how only the senior dev was familiar with the find usages tool.}
...
\todo[inline]{we need to better define the intellij find usages tool for readers unfamiliar with the ide and this part of it.}

\todo[inline]{Below section needs two screenshots to compare, one of classic find usages and another of our extension.}
...
\todo[inline]{we need an schematic to convey the concept of FUU, Emad can do it with Omnigraffle }
